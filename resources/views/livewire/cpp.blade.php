<div>
    <div id="cpp-swiper" class="swiper1 swiper pengantin"
        style="
            left: 17%;
            width: 66%;
            height: 53vh;
    ...
    <div class="fixed flex flex-col justify-center py-12 h-full w-full" >
        <div class="absolute py-3 px-4 max-w-xl mx-auto w-full"
            ...
            ">
            <div id="cpp-name" class="relative flex justify-end w-full flex-col rounded-xl bg-white bg-clip-border
                bg-opacity-40 backdrop-filter backdrop-blur-sm text-gray-700 shadow-md overflow-visible"
                style="
                    height: 60vh;
                    width: 75vw;
                ">
                <div id="cpp-name2" class="relative px-3 pb-8 text-center" style="opacity: 0">
    ...
    <img id="b1-17" src="{{asset('storage/images/bunga13.png')}}" alt="" style="opacity: 0; rotate: -5deg">
    <img id="b1-18" src="{{asset('storage/images/bunga14.png')}}" alt=""style="opacity: 0; rotate: 15deg">
    <img id="b1-19" src="{{asset('storage/images/bunga18.png')}}" alt=""style="opacity: 0; rotate: -5deg">
    <img id="b1-20" src="{{asset('storage/images/bunga19.png')}}" alt=""style="opacity: 0; rotate: -5deg">
